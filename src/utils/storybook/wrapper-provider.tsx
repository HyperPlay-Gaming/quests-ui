...
import { QuestWrapperProvider as Provider } from '@/state/QuestWrapperProvider'
...
} & Partial<QuestDetailsWrapperProps>) => {
  return <Provider {...mockProps} {...props}>{children}</Provider>
}
